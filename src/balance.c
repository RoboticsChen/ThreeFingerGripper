...
{ 
    ...
    {	
			...
			if(Check==0) //If self-check mode is not enabled //如果没有启动自检模式
			{
				...
				if(EN==0&&Time_count<200)
				{
				Drive_Motor(-0.2, Move_Y, Move_Z);
					
				}
				else if(EN==1)
				{
				Drive_Motor(0.5, Move_Y, Move_Z);
...
//					 if(!KEY)
//					 {
//					 MOTOR_A.Motor_Pwm=7000;//合为负，分开为正
//					 MOTOR_B.Motor_Pwm=0;
//					 MOTOR_C.Motor_Pwm=0;
//					 MOTOR_D.Motor_Pwm=0;}
//					 
...
//					 {
//					 MOTOR_A.Motor_Pwm=0;
//					 MOTOR_B.Motor_Pwm=5000;
//					 MOTOR_C.Motor_Pwm=5000;
//					 MOTOR_D.Motor_Pwm=-5000;
//					 }
//					 else if(EN==0)
//					 {
//					 MOTOR_A.Motor_Pwm=-7000;
//					 MOTOR_B.Motor_Pwm=5000;//负内正外
//					 MOTOR_C.Motor_Pwm=5000;
//					 MOTOR_D.Motor_Pwm=5000;
//					 }
					 Limit_Pwm(16700);
