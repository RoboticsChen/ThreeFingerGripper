...
void show_task(void *pvParameters)
{
   ...
   {	
		...
		if(Time_count<50&&Buzzer_flag==1){Buzzer=1; Buzzer_flag=0;}
...
//															OLED_ShowNumber(75,30, Remoter_Ch4,5,12);
		 ...
		 //显示当前小车是否允许控制
		 if(Flag_Stop==0)   OLED_ShowString(45,0,"O N");  
		 else                      OLED_ShowString(45,0,"OFF"); 
			
																OLED_ShowNumber(75,0,Voltage_Show/100,2,12);
			                          OLED_ShowString(88,0,".");
																OLED_ShowNumber(98,0,Voltage_Show%100,2,12);
			                          OLED_ShowString(110,0,"V");
		 if(Voltage_Show%100<10) 	OLED_ShowNumber(92,50,0,2,12);
		 OLED_ShowString(0,50,"MC  ");
		 if(MOTOR_C.Motor_Pwm<0) OLED_ShowString(20,50,"-"),
															 OLED_ShowNumber(30,50,-MOTOR_C.Motor_Pwm,4,12);
		 else                 	 OLED_ShowString(20,50,"+"),
															 OLED_ShowNumber(30,50, MOTOR_C.Motor_Pwm,4,12);
			 OLED_ShowString(60,50,"MD  ");
		 if(MOTOR_D.Motor_Pwm<0) OLED_ShowString(80,50,"-"),
																	 OLED_ShowNumber(90,50,-MOTOR_D.Motor_Pwm,4,12);
			else                 	 OLED_ShowString(90,50,"+"),
																	 OLED_ShowNumber(90,50, MOTOR_D.Motor_Pwm,4,12);
